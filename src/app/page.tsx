            ...
            <div className="relative w-full h-96 md:h-[500px] lg:w-4/5 lg:mx-auto rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105">
              ...
              <div className="absolute bottom-0 left-6 right-6 text-white pb-2">
                ...
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <span className="text-xs sm:text-sm font-medium">{averageRating}/5 ({reviews.length + 10}+ avis)</span>
                </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex space-x-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star 
                            key={star} 
                            className={`w-3 h-3 ${star <= currentReview.rating ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}`} 
                          />
                        ))}
                      </div>
                      <span className="text-xs font-medium">{currentReview.name}</span>
                    </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div id="footer-services">
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="#" className="hover:text-white transition-colors">Froid & Climatisation</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Dépannage</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Installation</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Maintenance</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Conseil</Link></li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3 pt-4">
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-lg transition-colors ${!newReview.name.trim() || !newReview.comment.trim() ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700'}`}
                  >
                    Envoyer l'avis
                  </button>
                </div>
